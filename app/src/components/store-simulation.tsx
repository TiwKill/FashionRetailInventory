...
import type { BrandConfig, BrandConfigs, MonthlyData, RestockEvent, DailyData, BestSellingProduct } from "@/types/index"
import { BRAND_COLORS } from "@/lib/constants"

/** Customer entity in store simulation */
type Customer = {
    id: number
    x: number
    y: number
...
/** Employee entity in store simulation */
type Employee = {
    id: number
    x: number
    y: number
